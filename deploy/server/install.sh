...
install -d -o root -g root -m 755 /usr/local/libexec /usr/local/sbin /etc/cvp-deploy /etc/cvp-deploy/nginx /srv /srv/cvp /var/lib/cvp-deploy
...
[ -e /etc/cvp-deploy/nginx/default.conf ] || install -o root -g root -m 644 "$SOURCE_DIR/../player.conf" /etc/cvp-deploy/nginx/default.conf
...
chown root:root /etc/cvp-deploy/nginx /etc/cvp-deploy/nginx/default.conf /srv /srv/cvp /var/lib/cvp-deploy
chmod 755 /etc/cvp-deploy/nginx /srv /srv/cvp /var/lib/cvp-deploy
